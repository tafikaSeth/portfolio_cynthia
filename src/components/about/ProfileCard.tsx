...
import { ANIMATION_CONFIG, DEFAULT_BEHIND_GRADIENT, DEFAULT_INNER_GRADIENT } from "@/constants";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    <motion.div
      ...
      initial={enableAnimations ? { opacity: 0, y: -100 } : undefined}
      whileInView={enableAnimations ? { opacity: 1, y: 0, transition: { delay: 0.8, duration: 0.8 } } : undefined}
      viewport={enableAnimations ? { once: false, amount: 0.5 } : undefined}
    >
